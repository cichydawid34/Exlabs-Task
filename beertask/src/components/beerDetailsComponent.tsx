      ...
      <div className="flex flex-col gap-8 p-24 pt-12 md:grid md:grid-cols-12 lg:ml-48">
        ...
        <>
          ...
          <div className="col-span-8 flex flex-col gap-2 rounded-xl p-8 lg:col-span-5 ">
            ...
            <p className="text-sm text-zinc-500">{data.tagline}</p>
            <div className="mx-2 my-1 flex  w-[80%] flex-row justify-between">
              <p className="text-lg">
                ABV: <span className="font-bold">{data.abv}</span>
              </p>
              <p className="text-lg">
                IBU: <span className="font-bold">{data.ibu}</span>
              </p>
            </div>

            <div>
              <p className="text-zinc-800">{data.description}</p>
            </div>
        ...
        <div className="col-span-12 items-center justify-center align-middle ">
          ...
          <ul>
            {data.ingredients.hops.map((ingredient: any, index) => (
              <>
          ...
          <ul>
            {data.ingredients.malt.map((ingredient: any, index) => (
              <li key={index} className="list-disc">
                {ingredient.name}
                {" - "}
                <span className="font-bold">
